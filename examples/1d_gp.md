...
Please see [`stan/1d_gp.stan`](stan/1d_gp.stan) for model details.
...
For the [`strongly_informative`](figs/1d_gp/strongly_informative/61a3486baa7b926f0a6379f6b4714ad5.png) configuration, the data are so informative that
the basis function coefficients are very well determined and a centered parametrization
would have been more appropriate. For the [`informative`](figs/1d_gp/informative/3d81c6e756d65feff3c2bb3e2a2923dd.png) or [`weakly_informative`](figs/1d_gp/weakly_informative/f138dcd32eab41d15c5d85732f0b28d7.png)
configuration, this is less clear.

[^1]: forgot the correct name for this.

## Sample visualization (`config=strongly_informative`)

![](figs/1d_gp/strongly_informative/61a3486baa7b926f0a6379f6b4714ad5.png)


## Commented code ([`examples/1d_gp.py`](1d_gp.py))
...
* There, [`DrawsPool.psis`](../xstanpy/base.py#L983) gets called.
...
* Back in [`DrawsPool.psis`](../xstanpy/base.py#L983), the prolongated draws are used to compute the
...
this preparation generally still has to happen in a custom [`Model`](../xstanpy/base.py#L145) subclass.**
```python
    adaptive = Adaptive(
        posterior,
