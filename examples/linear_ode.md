...
## Commented code ([`examples/linear_ode.py`](linear_ode.py))
...
A [`Model`](../xstanpy/base.py#L145) object takes care of compilation and stores additional information about
the model, e.g.
* how to slice its data for use by [`Incremental`](../xstanpy/incremental.py#L81) objects via their
[`Incremental.slice_update`](../xstanpy/incremental.py#L101) and [`Incremental.data_reconfiguration`](../xstanpy/incremental.py#L117) methods
* and how to refine a posterior's approximation via [`Adaptive`](../xstanpy/incremental.py#L163) objects using their
[`Adaptive.refinement_update`](../xstanpy/incremental.py#L168) and their adapted [`Adaptive.data_reconfiguration`](../xstanpy/incremental.py#L181) methods.

The models [`Model.compilation_process`](../xstanpy/base.py#L169) is a [`Command`](../xstanpy/base.py#L99) object which handles
communication with the spawned subprocess. Its [`Command.debug`](../xstanpy/base.py#L130) method
...
A [`Posterior`](../xstanpy/base.py#L225) object is defined by specifying a [`Model`](../xstanpy/base.py#L145) object and
a `dict` of data. The [`Posterior`](../xstanpy/base.py#L225) object handles metadata such as
* [`Posterior.constrained_parameter_names`](../xstanpy/base.py#L239): the names of the constrained parameters,
* [`Posterior.no_constrained_parameters`](../xstanpy/base.py#L255): the number of constrained parameters,
* [`Posterior.no_unconstrained_parameters`](../xstanpy/base.py#L259): the number of *unconstrained* parameters and
* [`Posterior.column_info`](../xstanpy/base.py#L263): parameterwise slice and shape data for easy access of properly reshaped
objects
```python
    prior = Posterior(model, prior_data)
```

An [`HMC`](../xstanpy/base.py#L938) object saves the CmdStan's `sample` method output for several chains (default: 6).
...
* [`HMC.stan_regular`](../xstanpy/base.py#L1055) calls CmdStan's `sample` method with Stan's default arguments
```python
    prior_fit = HMC.stan_regular(prior, warmup_no_draws=100, sampling_no_draws=100)
```

Both an [`HMC`](../xstanpy/base.py#L938) object's [`HMC.samples`](../xstanpy/base.py#L981) and [`HMC.draws`](../xstanpy/base.py#L978) properties
return [`DrawsPool`](../xstanpy/base.py#L909) objects, which allow for some convenience functionalities.
...
directly on the [`DrawsPool`](../xstanpy/base.py#L909) object to its subelements via its inherited
[`Pool.__getattr__`](../xstanpy/base.py#L809) method. In addition, [`DrawsPool`](../xstanpy/base.py#L909) objects inherit the following
convenience properties from the [`Pool`](../xstanpy/base.py#L805) class:
